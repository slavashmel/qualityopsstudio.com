...
- Repository: `https://github.com/slavashmel/qualityopsstudio.com.git`

## First install outline

```bash
adduser --system --group --home /opt/qualityopsstudio.com --shell /usr/sbin/nologin qualityops
mkdir -p /opt/qualityopsstudio.com/app
chown -R qualityops:qualityops /opt/qualityopsstudio.com

git clone https://github.com/slavashmel/qualityopsstudio.com.git /opt/qualityopsstudio.com/app
